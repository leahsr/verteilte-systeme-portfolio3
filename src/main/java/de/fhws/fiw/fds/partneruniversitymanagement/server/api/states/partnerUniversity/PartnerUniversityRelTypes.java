...
public interface PartnerUniversityRelTypes {
    ...
    String GET_ALL_PARTNER_UNIVERSITIES_BY_NAME_AND_COUNTRY = "getAllPartnerUniversitiesByNameAndCountry";
    String GET_ALL_PARTNER_UNIVERSITIES_BY_NAME_AND_COUNTRY_ASC = "getAllPartnerUniversitiesByNameAndCountryAscending";
    String GET_ALL_PARTNER_UNIVERSITIES_BY_NAME_AND_COUNTRY_DESC = "getAllPartnerUniversitiesByNameAndCountryDescending";
